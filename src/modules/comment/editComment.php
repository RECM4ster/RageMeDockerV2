...
$getComment = new getComment($_GET['commId']);
$data = $getComment->getCommentData();
...
<form id="loginForm" action="updateComm.php" METHOD="post">
    <input type="hidden" name = "id" value="<?php echo $viewData['com_id']?>"></br>
    <label class="loginLabel loginElement">Treść</label></br>
    <textarea class="loginInput loginElement" name="text" style="height:300px"><?php echo $viewData['com_body']?></textarea></br>
